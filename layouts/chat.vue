  ...
  <div class="WAL position-relative" :style="style">
    <q-layout view="lHh Lpr lFf" class="WAL__layout" container>
      ...
      <q-drawer v-model="leftDrawerOpen" show-if-above bordered :breakpoint="690">
        ...
        <q-toolbar>
          <q-input filled dense class="WAL__field full-width" v-model="search"
        ...
        <q-scroll-area style="height: calc(100% - 150px)">
          <q-list>
            <q-item v-for="(conversation, index) in conversations" :key="conversation.id" clickable v-ripple
        ...
        <q-toolbar>
          <q-toggle v-model="isDarkMode" @update:model-value="toggleDarkMode" :true-value="true" :false-value="false"
            checked-icon="dark_mode" color="accent" unchecked-icon="light_mode" size="45px" keep-color />
        </q-toolbar>
      </q-drawer>
...
// rewrite the code below to use composition API
// export default {
//   name: 'ChatLayout',
